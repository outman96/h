...
<h1> Simple Omlette Receipe</h1> 
<p>Simple Omelette Recipe An easy and quick dish, perfect for any meal. This classic omelette combines beaten eggs cooked to perfection, optionally filled with your choice of cheese, vegetables, or meats.</p>
<ul>prepartion time 
<li>Total: approximatly 10 minutes
</li>
<li>Preparation : 5 minutes
</li>
...
<h3>Ingriedients: </h3>
    ...
    <li>Optional fillings: diced vegtables,cooked meats,herbs</li>
 </ul>
 <h3>instructions: </h3>
 <ol>
    ...
    <li> old and serve: As the omelette continues to cook, carefully lift one edge and fold it over the fillings. Let it cook for another minute, then slide it onto a plate</li>
 <li> Enjoy: Serve hot, with additional salt and pepper if needed.</li>

 <li> fold and serve: As the omelette continues to cook, carefully lift one edge and fold it over the fillings. Let it cook for another minute, then slide it onto a plate</li></ol>
 <h3>nutrition</h3>
